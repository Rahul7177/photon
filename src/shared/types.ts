...
export interface PerModelConfig {
  ...
  sampling?: { temp?: number; topP?: number; seed?: number };
  note?: string;
}
...
export type ToolRisk = "read" | "workspace_write" | "execute" | "network" | "destructive";
export type ToolConcurrency = "safe_parallel" | "serial";
export type ToolIdempotency = "idempotent" | "stateful" | "non_idempotent";
export type VerificationKind = "diagnostics" | "tests" | "build" | "lint" | "runtime";

/** JSON-schema subset used by native calling and MCP. */
...
export interface VerificationPlan {
  required: VerificationKind[];
  completed: VerificationKind[];
  evidence: string[];
}

export interface TaskAnalysis {
  scope: "single_file" | "multi_file" | "codebase";
